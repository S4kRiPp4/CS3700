...
public class SMTPclient {
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            // TODO: Wait for read, and display "220" response from server (MESSAGE NEEDS TO COME FROM SERVER)
            System.out.println("Connection to: " + host + " responds with 220");
        ...
        while (open) {
            ...
            // to SMTP server, wait for SMTP server’s response and display it on the standard output.
            // TODO: Compute RTT of MAIL FROM

            // TODO: (c)Construct and send the “RCPT TO: <receiver’s email address>” command
            // to the SMTP server program, wait for SMTP server’s response and display it on the standard output.
            ...
            // If yes, repeat steps 3 through 5. Otherwise, send a “QUIT” command to the SMTP server, display SMTP Server’s response, close TCP
